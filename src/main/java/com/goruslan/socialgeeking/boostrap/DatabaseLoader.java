//package com.goruslan.socialgeeking.boostrap;
//
...
//
//        User user = new User("userg",secret,true,"John Doe");
//        user.addRole(userRole);
//        user.setConfirmPassword(secret);
//        userRepository.save(user);
//        users.put("user@gmail.com", user);
//
//        User admin = new User("admin",secret,true,"Admin Uiet");
//        admin.addRole(adminRole);
//        admin.setConfirmPassword(secret);
//        userRepository.save(admin);
//
//        User master = new User("super",secret,true,"Super Duper");
